...
public class Warning extends JFrame implements ActionListener
{
    ...
    public static final String IO_EXCEPTION_SUGGESTION = "1.Please make sure the file trying to open/edit is still in its original place.\n"
            ...
            + "\n If the \"Fix Problem\" button appears, you can click on it."
            + "\nThanks for your support.";

    public static final String JAVA_LAYER_EX_DESCRIBE = "An exception has occured during the process of converting"
            + "your music into readable format.\n";

    public static final String JAVA_LAYER_EX_SUGGESTION = ""
            + "Please make sure: "
            + "\n You are connected to the internet and the speed limit enables you to download music, if your music is online music.\n"
            + "In lot of cases, this exception are because of the input stream are stopped unexpectly because of unstable internet.\n"
            + "Also, please make sure you have input currect music format, .mp3 and .wav are only supported format.Otherwise, please convert them first.\n"
            + "Make sure your file is readable either."
            + "\n If all solutions don't figure out, please contact the author attach with the log file."
            + "\n Thank you for your support."
            + "\n If the \"Fix Problem\" button appears, you can click on it.";
    ...
    public static final String NUMBER_FM_EXCEPTION_SUGGESTION = "Please check your entrys and re-enter your numbers. If the \"Fix Problem\" button is shown above, you can click on it.";
...
//            detailPane.setVisible(true);
    ...
    private void initComponents()
    {
        ...
        this.getContentPane().setBackground(new Color(randomInt(0, 255), randomInt(0, 255), randomInt(0, 255)).brighter());
        ...
        hatLabel = new JLabel(IM.openIcon("hat1.jpg", 251, 249));
        ...
        suggestionArea = new JTextArea(4, 9);
    ...
    /**
     * Print the complete exception message into the <code>detailArea</code>.
     *
    ...
    private void log(Throwable throwable)
    {
        ...
        try
        {
            ...
            detailPane.getHorizontalScrollBar().setValue(1);
        } catch (Exception ex)
        {
    ...
    private void saveLog(File path, Throwable cause)
    {
        ...
        try
        {
            ...
            confirm = javax.swing.JOptionPane.showConfirmDialog(this, "A log file has successfully created. Located at: " + out.getPath() + " Do you want to open the directory now?", "Completed", javax.swing.JOptionPane.YES_NO_OPTION, javax.swing.JOptionPane.QUESTION_MESSAGE);
    ...
    /**
     * Create a warning dialog according to the exception. That warning dialog
     * will try best to give user hints.
     *
     * @param cause The exception caught.
     * @return The Object of the warning dialog created.
     */
    public static Warning createWarningDialog(Throwable cause)
    {
        if (cause == null)
        {
            return new Warning("An unknown exception has occured.");
        } else
        {
            ...
            } else if (cause instanceof JavaLayerException)
            {
                return new Warning(JAVA_LAYER_EX_DESCRIBE, JAVA_LAYER_EX_SUGGESTION + DETAIL_LISTED, cause, true);
            } else
            {
                return new Warning("An exception has occured. " + cause.getMessage(), "Please refer to information above. If you can't figure out, please contact the author 932646988@qq.com\n"
                        + "If the \"fix problem\" button appears, you can click on it. ", cause, false);
            }
        }
    }
    ...
    {
        setBackground(new Color(Randomizer.randomInt(0, 255), Randomizer.randomInt(0, 255), Randomizer.randomInt(0, 255)));
    }
    ...
    public static void main(String[] args)
    {
        ...
        {
            createWarningDialog(e);
           // Warning standardFrame = new Warning("Smart warning", "suggestion",e,true);//, e, true,
//                    () ->
//            {
//                JOptionPane.showMessageDialog(null, "Reset your number");
//            });
        }
